...
namespace JWT.BLL.Helpers
{
    ...
    {
        public static async Task SendConfirmationEmailAsync(IEmailService emailService, string toEmail, string token)
        {
            string emailContent = EnailContent(toEmail, token);
            string subject = "Confirm Your Email";

            await emailService.SendEmailAsync(toEmail, subject, emailContent);
        }

        private static string EnailContent(string email, string token)
        {
            string style =
    @"
    <style>
